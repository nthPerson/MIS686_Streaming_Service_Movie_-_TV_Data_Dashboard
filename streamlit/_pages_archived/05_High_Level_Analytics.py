"""Legacy dashboard layout with shared sidebar filters."""
...
def run() -> None:
	st.set_page_config(page_title="High-Level Analytics", layout="wide")
	user = require_user()
	...
	with status_col:
		...
		if hasattr(st, "page_link"):
			st.page_link("app.py", label="⬅️ Back to landing questions", icon="🏠")
	with action_col:
